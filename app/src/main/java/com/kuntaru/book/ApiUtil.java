...
public class ApiUtil {
    ...
    public static final String API_KEY = "AIzaSyCK95zfuQBLM0RXV58ulWmkt9zznb0269c";
    ...
    public static URL buildUrl(String title, String author, String publisher, String s) {
        URL url = null;
    ...
    public static ArrayList<Book> getBooksFromJson(String json) {
        ...
        final String PUBLISHER_DATE = "publisherDate";

        final String ITEMS = "items";
        final String VOLUMEINFO = "volumeInfo";
        final String DESCRIPTION = "description";
        final String IMAGEINFO = "imageUrl";
        ...
        try {
            ...
            for (int i = 0; i < numberOfBooks; i++) {
                ...
                if (volumeInfoJSON.has(IMAGEINFO)) {
                    volumeInfoJSON.getJSONObject(IMAGEINFO);
                }
                int authorNum;
                try {
    ...
    public static URL buildUrl(String cooking) {
        return null;
    }
}